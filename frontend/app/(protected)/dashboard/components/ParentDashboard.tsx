    ...
    return (
      <div className="min-h-screen flex items-center justify-center px-4">
        <div className="bg-white rounded-2xl shadow-sm p-8 max-w-md w-full text-center">
          <h3 className="font-semibold text-lg mb-2">Не удалось загрузить дашборд</h3>
          <p className="text-sm text-gray-500 mb-4">Попробуйте ещё раз. Если повторится — напишите в поддержку.</p>
          <button
            type="button"
            onClick={fetchOverview}
            className="px-5 py-2 bg-purple-600 text-white rounded-full text-sm font-semibold hover:bg-purple-700"
          >
            Повторить
          </button>
        </div>
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-purple-50 via-white to-blue-50 px-4 py-12 flex items-center justify-center">
        <div className="bg-white/80 backdrop-blur rounded-2xl p-8 shadow-sm max-w-md w-full text-center">
          ...
          <Link
            href="/children"
            className="inline-flex items-center px-5 py-2 bg-purple-600 text-white rounded-full text-sm font-semibold hover:bg-purple-700"
          >
            Добавить ребёнка
          </Link>
        </div>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8">
        ...
        <div className="flex flex-wrap gap-3 mb-8">
          ...
          <StatPill
            ...
            delta={signed(totals.testsPassedDeltaMonth, 'за месяц')}
            icon="check"
          />
          <StatPill
            ...
            delta={totals.avgScoreDeltaMonth !== null
              ...
              <div key={child.id} className="bg-white/80 backdrop-blur rounded-2xl p-6 shadow-sm">
                ...
                <div className="mt-4">
                  <div className="flex justify-between items-center mb-1">
                    <p className="text-sm text-gray-500">Прогресс программы</p>
        ...
        {attentionZone.length > 0 && (
          <div className="bg-white/80 backdrop-blur rounded-2xl p-6 shadow-sm mb-8 border border-amber-100">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h3 className="text-base font-bold text-gray-900">Требуют наблюдения</h3>
